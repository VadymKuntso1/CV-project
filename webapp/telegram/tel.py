...
from webapp.dbproject import models
from webapp.dbproject.models import Table
from webapp.dbproject.forms import TableForm
...
list - Take values from previous project
add - Add new value to previous project
